...
import { ContractServiceProxy, ContractInput, ContractDto, ComboboxItemDto, BidDto, SupplierDto, BidServiceProxy, GoodsServiceProxy, ContractPaymentServiceProxy, ContractPaymentInput } from '@shared/service-proxies/service-proxies';
