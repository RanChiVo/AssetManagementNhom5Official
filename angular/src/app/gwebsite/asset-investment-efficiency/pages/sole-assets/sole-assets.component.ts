...
@Component({
    templateUrl: './sole-assets.component.html',
    styleUrls: ['./sole-assets.component.css'],
    animations: [appModuleAnimation()]
})
export class SoleAssetsComponent extends AppComponentBase implements OnInit {
        ...
        if (this.generalStatisticsChart1ComparisonValue === 0) {
            ...
            if (this.activeGeneralStatisticsChart1Tab === 0) {
                if (this.generalStatisticsChart1ValueType === 0) {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Số vốn đã thu về (VNĐ)';
                    chartData = [{ data: tempData, label: 'Số vốn đã thu về (VNĐ)' }];
                }
                else {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Tỉ lệ phần trăm so với tổng số vốn đã thu về (%)';
                    chartData = [{ data: tempData, label: 'Tỉ lệ phần trăm so với tổng số vốn đã thu về (%)' }];
                }
            }
            else {
                if (this.generalStatisticsChart1ValueType === 0) {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Số lượng tài sản đã thanh lý (Tài sản)';
                    chartData = [{ data: tempData, label: 'Số lượng tài sản đã thanh lý (Tài sản)' }];
                }
                else {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Tỉ lệ phần trăm so với tổng số lượng tài sản đã thanh lý (%)';
                    chartData = [{ data: tempData, label: 'Tỉ lệ phần trăm so với tổng số lượng tài sản đã thanh lý (%)' }];
                }
            }
        }
        else {
