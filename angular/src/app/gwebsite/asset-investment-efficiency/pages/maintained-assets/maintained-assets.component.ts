        ...
        if (this.generalStatisticsChart1ComparisonValue === 0) {
            ...
            if (this.activeGeneralStatisticsChart1Tab === 0) {
                ...
                if (this.generalStatisticsChart1ValueType === 0) {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Số lượng tài sản đã bảo trì (Tài sản)';
                    chartData = [{ data: tempData, label: 'Số lượng tài sản đã bảo trì (Tài sản)' }];
                }
                else {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Tỉ lệ phần trăm so với tổng số lượng tài sản đã bảo trì (%)';
                    chartData = [{ data: tempData, label: 'Tỉ lệ phần trăm so với tổng số lượng tài sản đã bảo trì (%)' }];
                }
            }
        }
        else {
