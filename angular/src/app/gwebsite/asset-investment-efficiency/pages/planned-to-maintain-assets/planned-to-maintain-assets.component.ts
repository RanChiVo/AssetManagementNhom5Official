        ...
        if (this.generalStatisticsChart1ComparisonValue === 0) {
            ...
            if (this.activeGeneralStatisticsChart1Tab === 0) {
                if (this.generalStatisticsChart1ValueType === 0) {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Số vốn dự kiến đầu tư (VNĐ)';
                    chartData = [{ data: tempData, label: 'Số vốn dự kiến đầu tư (VNĐ)' }];
                }
                else {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Tỉ lệ phần trăm so với tổng số vốn dự kiến đầu tư (%)';
                    chartData = [{ data: tempData, label: 'Tỉ lệ phần trăm so với tổng số vốn dự kiến đầu tư (%)' }];
                }
            }
            else {
                if (this.generalStatisticsChart1ValueType === 0) {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Số lượng tài sản dự kiến bảo trì (Tài sản)';
                    chartData = [{ data: tempData, label: 'Số lượng tài sản dự kiến bảo trì (Tài sản)' }];
                }
                else {
                    ...
                    this.generalStatisticsChart1VerticalAxeLabel = 'Tỉ lệ phần trăm so với tổng số lượng tài sản dự kiến bảo trì (%)';
                    chartData = [{ data: tempData, label: 'Tỉ lệ phần trăm so với tổng số lượng tài sản dự kiến bảo trì (%)' }];
                }
            }
        }
        else {
